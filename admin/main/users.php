				...
				<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
					...
					<tbody>
						...
						for ($i = 0; $row = $result->fetch(); $i++) {
							...
							<td><a title="Click to view the user" href="viewuser.php?id=<?php echo $row['id']; ?>"><button
										class="btn btn-success btn-mini"><i class="icon-search"></i> View</button> </a>
								<a title="Click to edit the user" href="edituser.php?id=<?php echo $row['id']; ?>"><button
										class="btn btn-warning btn-mini"><i class="icon-edit"></i> Edit</button> </a>
								<a title="Click to delete" href="#" id="<?php echo $row['id']; ?>" class="delbutton"><button
