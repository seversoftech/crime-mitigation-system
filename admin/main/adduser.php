        ...
        <div style="margin-top: -19px; margin-bottom: 21px;">
          ...
          <form action="saveuser.php" method="post" enctype="multipart/form-data">
            ...
            <center>
              ...
              <link href="../style.css" media="screen" rel="stylesheet" type="text/css" />
              <div id="ac">
                <span>Full Name : </span><input type="text" style="width:265px; height:30px;" name="fullname"
                  Required /><br>
                ...
                <span>Phone: </span><input type="text" style="width:265px; height:30px;" name="phone"
                  pattern="^(\+?234|0)[\d]{10}$" required />
                <br>
                ...
                <div>
                  ...
                  <button class="btn btn-success btn-block btn-large" style="width:267px;"><i
                      class="icon icon-save icon-large"></i> Save user</button>
                </div>
              </div>
          </form>
          </center>
